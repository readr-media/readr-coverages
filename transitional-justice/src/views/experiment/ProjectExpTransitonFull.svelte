    ...
    <section class="main-section__story main-section__butterfly-story butterfly-story">
      ...
      <section class="story-section">
        <article class="article">
          <div class="text-box" data-chapter="1" data-scene="0" data-next="1-1" data-prev="" style="visibility: hidden">placeholder for 1-0</div>
      ...
      <section class="story-section">
        <article class="article">
          <div class="text-box" data-chapter="2" data-scene="0" data-next="2-1" data-prev="1-9" style="visibility: hidden">placeholder for 2-0</div>
