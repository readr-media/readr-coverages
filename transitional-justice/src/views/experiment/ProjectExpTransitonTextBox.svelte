...
<!--    <section class="main-section__story main-section__seperator-story seperator-story">-->
<!--      <span>腳本編號 04 第一章：受難者群像</span>-->
...
<!--          <img src="./exp/mockChapter2.png" alt="">-->
      ...
      <section class="story-section">
        <article class="article">
          <div class="text-box" data-chapter="1" data-scene="0" data-next="1-1" data-prev="1-0" style="transform: translateX(calc(-100vw / 2 + 50px + 250px)); box-shadow: none"><img style="width: 100%" src="./exp/mockChapter1.png" alt=""></div>
      ...
      <section class="story-section">
        <article class="article">
          <div class="text-box" data-chapter="2" data-scene="0" data-next="2-1" data-prev="1-9" style="transform: translateX(calc(-100vw / 2 + 50px + 250px)); box-shadow: none"><img style="width: 100%" src="./exp/mockChapter2.png" alt=""></div>
    ...
    scroller
      ...
      .onStepEnter(response => {
        ...
        if (response.direction === 'down') {
          ...
          if (response.element.dataset.scene === '0') {
            currentChapter = response.element.dataset.prev.split('-')[0]
            currentScene = response.element.dataset.prev.split('-')[1]
            return
          }
