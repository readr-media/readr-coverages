<template>
  <section class="article">
    ...
    <div>
      ...
      <p>
        事故發生不到1個月，花蓮地檢署偵查顯示，包商李義祥借牌投標台鐵工程，因施工進度落後，4
        月2日違規趕工，導致他過失致死等行為起訴包商李義祥等7人以及東新營造公司，<UiAnnotation
          :text="'字裡行間'"
      ...
      <p>
        8月23日，獨立調查單位國家運輸安全委員會發布「0402台鐵第408次車清水隧道重大鐵道事故第一階段事實報告」，總算揭露更多關鍵訊息：一連串人為失誤，台鐵難辭其咎。
      </p>
    </div>
  </section>
</template>
